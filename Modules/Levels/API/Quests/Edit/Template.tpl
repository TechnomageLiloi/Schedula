...
<div id="application-Quests-edit">
    <a href="javascript:void(0)" onclick="Schedula.Levels.Quest.save('<?php echo $entity->getKey(); ?>');">Save</a>
    <a href="javascript:void(0)" onclick="Schedula.Levels.Quest.show('<?php echo $entity->getStatus(); ?>');">Cancel</a>
    <hr/>
    <table>
